...
# --- 1. Load & Clean Data -----------------------------------------------------
# Looks for edible_plants.csv in the same folder as this app.R file.
# Move your CSV into:  Desktop/VTPEH6270-Naiya/Data/ShinyAppHW6/
edible_plants_raw <- read_csv(
  file.path(dirname(rstudioapi::getSourceEditorContext()$path), "edible_plants copy.csv")
)
